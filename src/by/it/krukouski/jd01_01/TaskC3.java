...
class TaskC3 {
    ...
    static double getWeight(int a) {
        double gEarth = 9.81;
        double gMars = 3.86;
        double weightMars = (int) ((a / (gEarth / gMars)) * 1000);
        double c = weightMars % 10;
        if (c >= 5) {
            weightMars = (weightMars + 10);
        }
        double totalWeightMars = (int) (weightMars / 10);

        return totalWeightMars / 100;
    }
}
