...
public class Runner {
    ...
    public static void main(String[] args) {
        Scalar s = new Scalar(3.0);
        Vector v = new Vector(new double[]{1,2,3}); // закомментируйте вектор и/или
        Matrix m = new Matrix("{{1,2,3},{4,5,6},{7,8,9}}");// матрицу, если вы их не реализовали
